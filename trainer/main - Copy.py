...
def main():
    ...
    print("Accuracy: %0.4f" % accuracy_score(test_labels,prediction_rbf))
    ...
    print("Accuracy: %0.4f" % accuracy_score(test_labels,prediction_linear))
    
    print("\nResults for LinearSVC()")
    print("Training time: %fs; Prediction time: %fs" % (time_liblinear_train, time_liblinear_predict))
    report_lib=classification_report(test_labels, prediction_liblinear)
    print(report_lib)
    print("Confusion matrix:\n%s\n" % confusion_matrix(test_labels,prediction_liblinear))
